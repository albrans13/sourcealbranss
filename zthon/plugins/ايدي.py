...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت تربون"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ ✘𓆩𝘼𝙇𝘽𝙍𝘼𝙉𝙎𖠲𓆪 ™ ─┄─┄─┄─⋆"
zed_dev = (6534175982, 6534175982)
zel_dev = (6534175982, 6534175982)
zelzal = (6534175982, 6534175982)
