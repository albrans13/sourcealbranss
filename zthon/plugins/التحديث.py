...
async def upstream(event):
    ...
    if conf == "الان":
        ...
        await event.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 ✘𓆩𝘼𝙇𝘽𝙍𝘼𝙉𝙎 𖠲𓆪   - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت مارو .. انتظـر . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 ✘𓆩𝘼𝙇𝘽𝙍𝘼𝙉𝙎 𖠲𓆪   - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت مارو .. انتظـر . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 ✘𓆩𝘼𝙇𝘽𝙍𝘼𝙉𝙎 𖠲𓆪   - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت مارو .. انتظـر . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    ...
    if event.reply_to and event.sender_id in progs:
        ...
        if owner_id == zedub.uid:
            if event.message.message == "حدث":
                conf = "الان"
                event = await event.reply("**ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 ✘𓆩𝘼𝙇𝘽𝙍𝘼𝙉𝙎 𖠲𓆪   - تحـديثـات السـورس\n**•─────────────────•**\n\n**✾╎جـاري تـحــديــث الـسـورس بأمــر مـن المـطور ⎌****")
                off_repo = UPSTREAM_REPO_URL
                force_update = False
