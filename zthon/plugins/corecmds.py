...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ تنصيب ملفـات اضافيـه.",
        "الوصـف": "بالـرد ع اي ملف (يدعم سورس البرنس) لـ تنصيبه في بوتك.",
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ تحميـل اي ملف مـجددًا .. اذا كنت قد الغيت تحميله مسبقـاً",
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ تحميـل وجلب اي ملف من ملفـات السـورس اليك ع تيليجـرام",
...
@zedub.zed_cmd(
    ...
    command=("حمل", plugin_category),
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ الغـاء تحميـل اي ملـف من السـورس.",
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ الغـاء تنصيب اي ملـف من السـورس.",
