...
zel_dev = (6534175982, 5593884330, 5578760481)
...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝  𝘼𝙇𝘽𝙍𝘼𝙉𝙎 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/source_albrans) 🗑♻️𓆪\n**𓍹━─━─━─━─ 𝘼𝙇𝘽𝙍𝘼𝙉𝙎─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 6534175982 or user.id == 6534175982 or user.id == 6534175982:
...
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲  𝘼𝙇𝘽𝙍𝘼𝙉𝙎 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/source_albrans>) 𓆪\n\n"
