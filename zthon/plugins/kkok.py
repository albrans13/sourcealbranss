...
ZelzalDV_cmd = (
    "𓆩 [᥉᥆ᥙℛᥴᥱᥲ️ᥣႦℛᥲ️ꪀ᥉  - اوامــر المطـور المســاعد](t.me/source_albrans) 𓆪\n\n"
...
@zedub.zed_cmd(
    ...
    info={
        "ᥲ️ᥣႦℛᥲ️ꪀ᥉": "لـ تفعيـل/تعطيـل وضـع المطــور وفتـح/قفـل التحكـم لـ المطــور",
...
@zedub.zed_cmd(
    ...
    info={
        "ᥲ️ᥣႦℛᥲ️ꪀ᥉": "لـ رفـع مطـورين فـي بـوتك",
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت ✘ ᥲ️ᥣႦℛᥲ️ꪀ᥉  انتظـر 2-1 دقيقـه ▬▭ ...**"
...
@zedub.zed_cmd(
    ...
    info={
        "ᥲ️ᥣႦℛᥲ️ꪀ᥉": "لـ تنزيـل مطـور مـن بـوتك",
...
@zedub.zed_cmd(
    ...
    info={
        "ᥲ️ᥣႦℛᥲ️ꪀ᥉": "لـ عـرض قائمــه بمطـورين بــوتك",
...
@zedub.zed_cmd(
    ...
    info={
        "ᥲ️ᥣႦℛᥲ️ꪀ᥉": "To enable cmds for sudo users.",
        "flags": {
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت ✘ ᥲ️ᥣႦℛᥲ️ꪀ᥉  انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
...
@zedub.zed_cmd(
    ...
    info={
        "ᥲ️ᥣႦℛᥲ️ꪀ᥉": "To disable given cmds for sudo.",
        "flags": {
...
@zedub.zed_cmd(
    ...
    info={
        "ᥲ️ᥣႦℛᥲ️ꪀ᥉": "To show list of enabled cmds for sudo.",
