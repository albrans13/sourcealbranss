# 𝙏𝘼𝙍𝘽𝙊𝙐𝙉 ®
#الملـف حقـوق وكتابـة زلـزال الهيبـه ⤶ W_X_E1خاص بسـورس ⤶  𝙏𝘼𝙍𝘽𝙊𝙐𝙉
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝  𝘼𝙇𝘽𝙍𝘼𝙉𝙎 𓆪 </b> - @source_albrans "
...
async def who(event):
    ...
    if replied_user.id == 6534175982 or replied_user.id == 6534175982 or replied_user.id == 6534175982:
