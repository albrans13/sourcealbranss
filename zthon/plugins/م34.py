...
ZelzalDV_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝘽𝙍𝘼𝙉𝙎 - اوامر بوت استخراج الجلسات](t.me/source_albrans) 𓆪\n\n"
    "⪼ بوت استخراج جلسات الخاص بسورس البرنس  \n"
    "⪼(@tromx_1bot)n"
    "⪼برعاية المطور كينج  \n" 
    "⪼ ⪼ برعاية المطور البرنس \n"
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت  الـبرنس   انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت  الـبرنس   انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
