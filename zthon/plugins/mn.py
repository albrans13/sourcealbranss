...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 ✘ 𝘼𝙇𝘽𝙍𝘼𝙉𝙎  - بوت تحميل الافلام والمسلسلات من اليوتيوب](t.me/source_albrans) 𓆪\n\n"
    "⪼ يوزر بوت تحميل مسلسلات وافلام من اليوتيوب\n"
    "⪼ 𓅱 𝐔𝐒𝐄𝐑 @albrans_123_bot\n"
    "\n𓆩 [𐇮 ™✘ 𝘼𝙇𝘽𝙍𝘼𝙉𝙎  • 𐇮](t.me/source_albrans) 𓆪"
)
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت الـبرنـس  انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
