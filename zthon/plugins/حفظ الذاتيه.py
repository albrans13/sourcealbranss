...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝘼𝙍𝘽𝙊𝙐𝙉 - حفـظ الذاتـيـة ♥️](t.me/source_albrans) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝘼𝙇𝘽𝙍𝘼𝙉𝙎 ⃝🇧🇷](t.me/source_albrans) 𓆪"
)
