...
ZelzalDV_cmd = (
    "𓆩 [•✘𝑌𝑂𝐔𝑆𝑆𝐸𝐹 ™⤶](t.me/HH_7_T) 𓆪\n\n"
    "**⪼** 𓅯•✘𝑌𝑂𝐔𝑆𝑆𝐸𝐹 ™⤶\n"
    "**⪼** 𓅯𝐔𝐒𝐄𝐑: @HH_7_T\n"
    "**⪼** 𓅯𝐈𝐃: 6534175982\n"
    "**⪼** 𓅯𝐁𝐈𝐎✹: يوسف البرنس مطور بوتات التلي 🤞♥\n"
    "\n𓆩 [ ᥉᥆ᥙℛᥴᥱᥲ️ᥣႦℛᥲ️ꪀ᥉  ](t.me/HH_7_T) 𓆪"
)
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ تفعيـل/تعطيـل وضـع المطــور وفتـح/قفـل التحكـم لـ المطــور",
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ رفـع مطـورين فـي بـوتك",
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت الـبرنـس  انتظـر 2-1 دقيقـه ▬▭ ...**"
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ تنزيـل مطـور مـن بـوتك",
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "لـ عـرض قائمــه بمطـورين بــوتك",
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن ᥲ️ᥣႦℛᥲ️ꪀ᥉ :**\n\n"
...
async def _(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت البرنس  انتظـر 2-1 دقيقـه ▬▭ ...**"
    msg = await edit_or_reply(event, output)
    await event.client.reload(msg)
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "To enable cmds for sudo users.",
        "flags": {
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت البرنس  انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "To disable given cmds for sudo.",
        "flags": {
...
@zedub.zed_cmd(
    ...
    info={
        "𝑌𝑂𝐔𝑆𝑆𝐸𝐹": "To show list of enabled cmds for sudo.",
