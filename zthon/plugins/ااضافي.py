...
ZelzalDV_cmd = (
    "𓆩 [ 𝘼𝙇𝘽𝙍𝘼𝙉𝙎✹-اوامر رشق المشاهدات](t.me/source_albrans) 𓆪\n\n"
    "**⏎** اهلا بك في اوامر رشق مشاهدات\n"
    "**⏎**لاستعمال الامر ⏎ 𐇮`.رشق مشاهدات` +رابط المنشور ⏎\n"
    "\n𓆩 [𐇮 𝗦𝗢𝗨𝗥𝗖𝗘 𝘼𝙇𝘽𝙍𝘼𝙉𝙎  𐇮](t.me/source_albrans) 𓆪"
)
