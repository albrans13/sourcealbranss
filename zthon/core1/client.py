                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @source_albrans \
                                  \n\n--------بـدء تتبـع سجـل البرنس ✘𓆩 𝘼𝙇𝘽𝙍𝘼𝙉𝙎𖠲𓆪 ™𝘼𝙇𝘽𝙍𝘼𝙉𝙎 ⃝🇧🇷➼💎--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع البرنس ✘𓆩 𝘼𝙇𝘽𝙍𝘼𝙉𝙎𖠲𓆪 ™𝘼𝙇𝘽𝙍𝘼𝙉𝙎 ⃝🇧🇷➼💎--------"
                        ...
                        link = "[sourcealbrans (https://t.me/source_albrans )"
                        text = (
                            "**✘ تقـريـر إشعـار البرنس ✘𓆩 𝘼𝙇𝘽𝙍𝘼𝙉𝙎𖠲𓆪 ™𝘼𝙇𝘽𝙍𝘼𝙉𝙎 ⃝🇧🇷➼💎 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار البرنس ✘𓆩 𝘼𝙇𝘽𝙍𝘼𝙉𝙎𖠲𓆪 ™𝘼𝙇𝘽𝙍𝘼𝙉𝙎 ⃝🇧🇷➼💎 ✘**\n\n "
                        link = "[ 𝘼𝙇𝘽𝙍𝘼𝙉𝙎𓅯(https://t.me/source_albrans )"
