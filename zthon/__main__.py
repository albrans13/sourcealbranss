...
LOGS = logging.getLogger("سـورسـ الـبـرنـس")
...
try:
    LOGS.info("✧ بـدء تنزيـل الـبرنـس ✧")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["Gwmae","ADXG25","TRPN22","ADXG25","FOR_MONZER","Gwmae","Gwmae","ADXG25","TRPN22","ADXG25","FOR_MONZER"]
    ...
    print(f"⌔┊تـم تنصيـب الـبـرنـس . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()
